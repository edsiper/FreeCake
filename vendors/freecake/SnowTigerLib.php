...
//		print_r( $response );
	...
	*/
	...
	public function getPendingFeedback($type = 'B'){
		...
		$this->url = '/User/getPendingFeedback';
		$this->type = $type;
	 ...
	 *	budget(Required)	 		Budget of the project<br/>
	 ...
	 * @param Array $param (<br/>
	 * 	projectid(Required)<br/>
	 *	commenttext(Required)	 			Mandatory if 'newBid'<br/>
	 ...
	 * @param string $function	 withdrawalfee | projectfee | joblist | terms, withdrawalfee for default
	 */
...
class SnowTigerLib_Config {
	...
	private function __construct() {
		$this->_Config = require_once 'snowtiger_config.php';
